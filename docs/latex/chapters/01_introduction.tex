...
\begin{table}[h]
  ...
  \begin{tabular}{@{}lp{10cm}@{}}
    \toprule
    \textbf{Inclus} & Authentification JWT, multi-tenancy, œuvres, boutique, événements, paiements délégués au \kernel, wallet, abonnements, chat WebSocket, notifications, recherche, administration \\
    \midrule
...
\begin{table}[h]
  ...
  \begin{tabular}{@{}ll@{}}
    ...
    Paiements          & \kernel{} module billing — MyCoolPay (Mobile Money), Stripe (carte) \\

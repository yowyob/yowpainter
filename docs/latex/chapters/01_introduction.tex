...
\begin{table}[h]
  ...
  \begin{tabular}{@{}lp{10cm}@{}}
    \toprule
    \textbf{Inclus} & Authentification JWT, multi-tenancy, œuvres, boutique, événements, paiements PaymentProvider, wallet, abonnements, chat WebSocket, notifications, recherche, administration \\
    \midrule
...
\begin{table}[h]
  ...
  \begin{tabular}{@{}ll@{}}
    ...
    Paiements          & PaymentProvider (Mobile Money MTN, Orange, MoMo Pay) \\
